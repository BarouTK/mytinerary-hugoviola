...
function Footer() {
    return (
        <div>
            <footer className="footer p-10 bg-base-300 from-sky-500 to-indigo-500 text-primary-content ">
                ...
                <div>
                    ...
                    <p className="font-bold">
                        Travel Company Ltd. <br />Providing support since 2023.
                    </p>
                ...
                <div>
                        ...
                        <Link className="link link-hover" to='./CityFiltre.jsx'>Cities</Link>
